...
showMessage('Login exitoso', 'success');// Redirigir a la página de tareas
setTimeout(() => {
...
const welcomeMessage = document.getElementById('welcomeMessage');if (welcomeMessage) {
...
const data = await response.json();
if (response.ok) {displayTasks(data.tasks);
} else {
